...
void phaseTwoChores(struct fsmStr *fsm)
{
        ...
        setDutyCycle(&balance_motor,BALANCE_MOTOR_DC);
        for (uint8_t i = 0; i < 4; i++)
        {
                if (i != motor_index)
                {
...
void resetIntState(struct fsmStr *fsm,const enum FSM_States *state)
{
        switch(*state)
        {
                ...
                case PHASE_1:
                        ...
                        blnc_int_arr[0].intState = STATE_A;
                        blnc_int_arr[1].intState = STATE_B;
                        blnc_int_arr[2].intState = STATE_A;
                        blnc_int_arr[3].intState = STATE_A;
                ...
                case PHASE_2:
                        ...
                        int_arr[3].intState = STATE_A;
                        blnc_int_arr[0].intState = STATE_A;
                        blnc_int_arr[1].intState = STATE_A;
                        blnc_int_arr[2].intState = STATE_B;
                        blnc_int_arr[3].intState = STATE_A;
                ...
                case PHASE_3:
                        ...
                        int_arr[3].intState = STATE_A;
                        blnc_int_arr[0].intState = STATE_B;
                        blnc_int_arr[1].intState = STATE_A;
                        blnc_int_arr[2].intState = STATE_A;
                        blnc_int_arr[3].intState = STATE_A;
                        break;
