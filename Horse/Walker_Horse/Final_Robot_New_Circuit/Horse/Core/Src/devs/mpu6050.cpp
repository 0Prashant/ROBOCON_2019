...
int8_t MPU6050_Init(struct MPU6050 *mpu)
{
        ...
        i2c_buffer[1] = (0x00);
        HAL_StatusTypeDef h1 = HAL_I2C_Master_Transmit(mpu->hi2c, mpu->address, i2c_buffer, 2, 15);
        
        i2c_buffer[0] = SMPLRT_DIV;        // SMPLRT_DIV
        i2c_buffer[1] = 0x19;
        HAL_StatusTypeDef h2 = HAL_I2C_Master_Transmit(mpu->hi2c, mpu->address, i2c_buffer, 2, 15);
        
        i2c_buffer[0] = CONFIG;            // CONFIG
        i2c_buffer[1] = 0x00;
        HAL_I2C_Master_Transmit(mpu->hi2c, mpu->address, i2c_buffer, 2, 15);
