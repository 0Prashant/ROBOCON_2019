...
void leg_init(){
	leg[0].set_config(&motor_configurations[1], &encoder_configurations[0]);
	leg[1].set_config(&motor_configurations[2], &encoder_configurations[1]);
	leg[0].set_gravity_compensator_constant(0.49);
	leg[1].set_gravity_compensator_constant(0.49);
}	

void steering_init(){
	steering.set_config(&motor_configurations[0], &encoder_configurations[2]);
}
