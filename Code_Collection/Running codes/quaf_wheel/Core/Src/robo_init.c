...
void leg_init(void)
{
        ...
        leg_arr[0].pneu_port = GPIOE;
        leg_arr[0].pneu_pin = GPIO_PIN_8;
        ...
        leg_arr[1].pneu_port = GPIOC;
        leg_arr[1].pneu_pin = GPIO_PIN_3;
        ...
        leg_arr[2].pneu_port = GPIOC;
        leg_arr[2].pneu_pin = GPIO_PIN_1;
        ...
        leg_arr[3].pneu_port = GPIOB;
        leg_arr[3].pneu_pin = GPIO_PIN_2;
